...
describe('Codex quota history translations', () => {
  ...
  it.each([
    ['en', '1-point sample', 'Multi-point average', '{{count}}-point average', 'Used', 'Full-quota estimate', 'Median per 1%'],
    ['zh', '单百分点样本', '多百分点均摊', '{{count}} 个百分点均摊', '已用', '满额估算', '每 1% 中位数'],
    ['zh-TW', '單百分點樣本', '多百分點均攤', '{{count}} 個百分點均攤', '已用', '滿額估算', '每 1% 中位數'],
  ])('describes quota samples and summaries clearly in %s', (language, direct, cross, crossPoints, used, fullEstimate, medianPerPoint) => {

...
describe('UsagePage toolbar styles', () => {
  ...
  it('keeps the Analysis chart presentation aligned with the reference design', () => {
    ...
    expect(analysisPanelSource).toContain('<span className={styles.heatmapCellTokenValue}>T: {formatCompactNumber(heatmapTokens)}</span>')
    expect(analysisPanelSource).toContain('<span className={styles.heatmapCellRequestValue}>R: {formatCompactNumber(heatmapRequests)}</span>')

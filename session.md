...
- **Latest milestone:** Full project documentation set created (`README.md` overhaul + `docs/SPECIFICATION.md`, `docs/ARCHITECTURE.md`, `docs/ROADMAP.md`, `docs/CONFIGURATION.md`, `docs/CONTRIBUTING.md`).
